...
abstract class EntityModel
{
   ...
   /*  var $updates; // data to be changed */
    ...
    public function defineKey(string $name, int $value)
    {
        $this->primaryKey = $name;
        $this->ID = $value;
    }

    public function defineField(string $name, string $format = 'alpha')
    {
    ...
    public function load()
    {
        ...
        $sql = 'select ' . $this->fieldNames() . ' from ' . $this->table . ' where ' . $this->primaryKey . '=' . $this->ID;
    ...
    */
    ...
    protected function setValue(string $key, int|float|string $value)
    {
